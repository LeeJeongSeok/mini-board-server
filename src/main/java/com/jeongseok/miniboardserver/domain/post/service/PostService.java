...
public class PostService {
	...
	public boolean verifyPassword(VerifyPostRequest verifyPostRequest) {
		Post post = postRepository.findById(verifyPostRequest.getPostId())
			.orElseThrow(() -> new IllegalArgumentException("게시글을 찾을 수 없습니다. ID:" + verifyPostRequest.getPostId()));

		return simpleEncrypt.isMatch(verifyPostRequest.getPassword(), post.getPassword());
	}
}
