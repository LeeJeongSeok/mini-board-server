...
public class PostService {
	...
	public boolean verifyPassword(VerifyPostAuthRequest verifyPostAuthRequest) {
		Post post = postRepository.findById(verifyPostAuthRequest.getPostId())
			.orElseThrow(() -> new IllegalArgumentException("게시글을 찾을 수 없습니다. ID:" + verifyPostAuthRequest.getPostId()));

		return simpleEncrypt.isMatch(verifyPostAuthRequest.getPassword(), post.getPassword());
	}
}
